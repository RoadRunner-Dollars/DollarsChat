...
<?php e(t("Room Name")) ?> <input type="textbox" name="room_name" value="<?php e($dura['room']['name']) ?>" size="27" maxlength="30" /> <input type="button" name="save" value="<?php e(t("Change")) ?>" /><br />
<hr />
